...
//            }
			...
			RaycastHit2D ray = Physics2D.Raycast(m_GroundCheck.position, Vector2.down, 0.2f, m_WhatIsGround );
        ...
        public void MoveUD(bool exit)
        {
      	...
      	public void Shoot()
      	{
      		m_Anim.SetTrigger(Hash.Animations.Character.trigger_Shooting);
        ...
        {
        	PlatformerCharacter2D _pc2D = (PlatformerCharacter2D) GameObject.FindObjectOfType<PlatformerCharacter2D>();
        	return _pc2D.isFacingRight;

        }

        public static void CanControl(bool canControl)
        {
			PlatformerCharacter2D _pc2D = (PlatformerCharacter2D) GameObject.FindObjectOfType<PlatformerCharacter2D>();
        	_pc2D.canMove = canControl;
